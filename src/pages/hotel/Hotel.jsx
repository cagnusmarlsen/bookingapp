...
export const Hotel = () => {
  ...
  const handleArrow = (direction) => {
    ...
    if(direction === "left") {
      newSlide = currentSlide === 0 ? 5 : currentSlide - 1;
    }
    else {
      newSlide = currentSlide === 5 ? 0 : currentSlide + 1;
    }
        ...
        <div className="hotelContainer">
          {openSlide && <div className="slider">
            ...
            <div className="sliderImgContainer">
              <img src={photos[currentSlide].src} alt="" className="sliderImg" />              
            </div>
            ...
            <div className="hotelWrapper">
                ...
                <div className="hotelAddress">
                    ...
                    <span>Elton st 121 New York</span>
                </div>
